...
function msg_receive(msg) {
  ...
  return (
    ...
    msg +
    "</div></div><div class='chat-time d-inline-block text-end fs-2 font-weight-medium'>" +
    h +
    ":" +
    m +
    "</div></li>"
...
function msg_sent(msg) {
  ...
  return (
    ...
    msg +
    "</div><br></div><div class='chat-time d-inline-block text-end fs-2 font-weight-medium'>" +
    h +
    ":" +
    m +
    "</div></li>"
