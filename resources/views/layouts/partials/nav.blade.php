        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="">
                ...
                <b class="logo-icon">
                    ...
                    <!-- Dark Logo icon -->
                    <img
                        src="{{ asset('src/assets/images/logo-icon-cbc.png') }}"
                        alt="homepage"
                        class="dark-logo"
                    />
                    <!-- Light Logo icon -->
                ...
                <!-- dark Logo text -->
                <img
                    src="{{ asset('src/assets/images/logo-text-cbc.png') }}"
                    alt="homepage"
                    class="dark-logo"
                />
                    <!-- Light Logo text -->
                ...
                <li class="nav-item dropdown">
                  ...
                  "
                    ...
                    "
                        ...
                        <a class="dropdown-item" href="{{ route('getProfil')}}" style="color: black;"
                        ><i
                                data-feather="user"
